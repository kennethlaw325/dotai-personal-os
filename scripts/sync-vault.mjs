...
// content-drafts.json: 唔再有專屬 dashboard view（Content Pipeline 已移除），
// 但 Day 2 H2「LLM aggregation」lesson（insights.mjs）仲會 aggregate tasks + drafts，
// 所以保留呢個 sync。content-creator 員工嘅 output 位 = _drafts/。
