...
1. 一個跑得起嘅 personal OS dashboard（4 個 view + 自己加嘅 1-2 個）
...
**目標**：你由 0 開始，60 分鐘後瀏覽器開 localhost:5173 見到 4 個 view render sample data。
...
**🎉 Wow moment #1**：4 個 view 已 work，你未寫過一行 code。
...
你應該見到 localhost:5173 同 localhost:4173 都 render 到 4 view。
